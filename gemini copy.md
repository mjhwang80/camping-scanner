                        ...
                        <div class="p-4 space-y-4 text-sm">
                            ...
                            <div class="space-y-3 pt-2 border-t">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <select class="flex-1 p-1 border rounded text-xs bg-white" id="execTypeSelect" onchange="document.getElementById('reservedTimeFields').classList.toggle('hidden', this.value === 'NOW')">
                                ...
                                <div id="reservedTimeFields" class="hidden flex items-center">
                                    ...
                                    <input type="datetime-local" id="reservedDateTime" step="1" class="flex-1 p-1 border rounded text-xs" />
